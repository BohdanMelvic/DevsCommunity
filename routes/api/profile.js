...
// @dest   Create or update user profile
// @access Private
router.post('/', [auth, [
...
// @dest   Delete profile, user & posts
// @access Private
...
router.put('/experience', [auth, [
    ...
    .not()
    .isEmpty(),
    check('fromD', 'From data is required')
    .not()
    .isEmpty()
]], async (req, res) => {
    const errors = validationResult(req);
